...
router.post('/selectpermit/check-category', function (req, res) {
  if(req.body['chosenCategory']=='Flood risk activities' || req.body['chosenCategory']=='Radioactive substances for non-nuclear sites' || req.body['chosenCategory']=='Water discharges' || (req.body['operatorType']!='Limited company' && req.body['operatorType']!='Sole trader' && req.body['operatorType']!='Limited liability partnership' && req.body['operatorType']!='Individual')) { // These categories are NOT online
